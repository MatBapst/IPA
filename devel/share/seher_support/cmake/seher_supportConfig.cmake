...
if(seher_support_CONFIG_INCLUDED)
  return()
endif()
set(seher_support_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(seher_support_SOURCE_PREFIX /home/mathieu/catkin_ws/src/seher_support)
  set(seher_support_DEVEL_PREFIX /home/mathieu/catkin_ws/devel)
  set(seher_support_INSTALL_PREFIX "")
  set(seher_support_PREFIX ${seher_support_DEVEL_PREFIX})
else()
  set(seher_support_SOURCE_PREFIX "")
  set(seher_support_DEVEL_PREFIX "")
  set(seher_support_INSTALL_PREFIX /home/mathieu/catkin_ws/install)
  set(seher_support_PREFIX ${seher_support_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'seher_support' is deprecated")
...
set(seher_support_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/mathieu/catkin_ws/devel/include;/home/mathieu/catkin_ws/src/seher_support/include;/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(seher_support_INCLUDE_DIRS "")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'aulon <aulon@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${seher_support_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'seher_support' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'seher_support' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mathieu/catkin_ws/src/seher_support/${idir}'.  ${_report}")
    endif()
    _list_append_unique(seher_support_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND seher_support_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND seher_support_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT seher_support_NUM_DUMMY_TARGETS)
      set(seher_support_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::seher_support::wrapped-linker-option${seher_support_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR seher_support_NUM_DUMMY_TARGETS "${seher_support_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::seher_support::wrapped-linker-option${seher_support_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND seher_support_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mathieu/catkin_ws/devel/lib;/home/mathieu/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(seher_support_LIBRARY_DIRS ${lib_path})
      list(APPEND seher_support_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'seher_support'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND seher_support_LIBRARIES ${lib})
    endif()
  endif()
...
set(seher_support_EXPORTED_TARGETS "seher_support_generate_messages_cpp;seher_support_generate_messages_eus;seher_support_generate_messages_lisp;seher_support_generate_messages_nodejs;seher_support_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${seher_support_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 seher_support_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${seher_support_dep}_FOUND)
      find_package(${seher_support_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${seher_support_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(seher_support_INCLUDE_DIRS ${${seher_support_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(seher_support_LIBRARIES ${seher_support_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${seher_support_dep}_LIBRARIES})
  _list_append_deduplicate(seher_support_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(seher_support_LIBRARIES ${seher_support_LIBRARIES})

  _list_append_unique(seher_support_LIBRARY_DIRS ${${seher_support_dep}_LIBRARY_DIRS})
  list(APPEND seher_support_EXPORTED_TARGETS ${${seher_support_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "seher_support-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${seher_support_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
