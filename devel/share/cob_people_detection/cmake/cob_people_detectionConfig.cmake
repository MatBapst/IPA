...
if("TRUE" STREQUAL "TRUE")
  set(cob_people_detection_SOURCE_PREFIX /home/mathieu/catkin_ws/src/cob_people_perception/cob_people_detection)
  set(cob_people_detection_DEVEL_PREFIX /home/mathieu/catkin_ws/devel)
  ...
  set(cob_people_detection_INSTALL_PREFIX /home/mathieu/catkin_ws/install)
...
if(NOT "/home/mathieu/catkin_ws/devel/include;/home/mathieu/catkin_ws/src/cob_people_perception/cob_people_detection/ros/include;/home/mathieu/catkin_ws/src/cob_people_perception/cob_people_detection/common/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cob_people_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/mathieu/catkin_ws/devel/include;/home/mathieu/catkin_ws/src/cob_people_perception/cob_people_detection/ros/include;/home/mathieu/catkin_ws/src/cob_people_perception/cob_people_detection/common/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/cob_people_detection " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/cob_people_detection' for information and consider reporting the problem.")
  else()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cob_people_detection_NUM_DUMMY_TARGETS)
      set(cob_people_detection_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cob_people_detection::wrapped-linker-option${cob_people_detection_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cob_people_detection_NUM_DUMMY_TARGETS "${cob_people_detection_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cob_people_detection::wrapped-linker-option${cob_people_detection_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cob_people_detection_LIBRARIES "${interface_target_name}")
...
set(cob_people_detection_EXPORTED_TARGETS "cob_people_detection_gencfg;cob_people_detection_generate_messages_cpp;cob_people_detection_generate_messages_eus;cob_people_detection_generate_messages_lisp;cob_people_detection_generate_messages_nodejs;cob_people_detection_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cob_people_detection_dep}_FOUND)
      find_package(${cob_people_detection_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cob_people_detection_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
