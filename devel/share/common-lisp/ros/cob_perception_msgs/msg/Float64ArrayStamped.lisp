...
(cl:defmethod cl:initialize-instance :after ((m <Float64ArrayStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64ArrayStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_perception_msgs-msg:<Float64ArrayStamped> is deprecated: use cob_perception_msgs-msg:Float64ArrayStamped instead.")))
...
(cl:defmethod data-val ((m <Float64ArrayStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:data-val is deprecated.  Use cob_perception_msgs-msg:data instead.")
  (data m))
