...
(cl:defmethod cl:initialize-instance :after ((m <PositionMeasurement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionMeasurement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_perception_msgs-msg:<PositionMeasurement> is deprecated: use cob_perception_msgs-msg:PositionMeasurement instead.")))
...
(cl:defmethod object_id-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:object_id-val is deprecated.  Use cob_perception_msgs-msg:object_id instead.")
  (object_id m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:pos-val is deprecated.  Use cob_perception_msgs-msg:pos instead.")
  (pos m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:vel-val is deprecated.  Use cob_perception_msgs-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'reliability-val :lambda-list '(m))
(cl:defmethod reliability-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:reliability-val is deprecated.  Use cob_perception_msgs-msg:reliability instead.")
  (reliability m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:covariance-val is deprecated.  Use cob_perception_msgs-msg:covariance instead.")
  (covariance m))

(cl:ensure-generic-function 'initialization-val :lambda-list '(m))
(cl:defmethod initialization-val ((m <PositionMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_perception_msgs-msg:initialization-val is deprecated.  Use cob_perception_msgs-msg:initialization instead.")
  (initialization m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PositionMeasurement>)))
  ...
  "a1ad9f58d180ee0dd8bd6c516af86714")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PositionMeasurement)))
  "Returns md5sum for a message object of type 'PositionMeasurement"
  "a1ad9f58d180ee0dd8bd6c516af86714")
