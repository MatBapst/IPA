...
(cl:defmethod cl:initialize-instance :after ((m <GetPointMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPointMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_3d_mapping_msgs-srv:<GetPointMap-request> is deprecated: use cob_3d_mapping_msgs-srv:GetPointMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetPointMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPointMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_3d_mapping_msgs-srv:<GetPointMap-response> is deprecated: use cob_3d_mapping_msgs-srv:GetPointMap-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPointMap)))
  ...
  "cob_3d_mapping_msgs/GetPointMap")