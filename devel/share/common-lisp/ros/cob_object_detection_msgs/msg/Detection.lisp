...
(cl:defclass <Detection> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (mask
    :reader mask
    :initarg :mask
    :type cob_object_detection_msgs-msg:Mask
    :initform (cl:make-instance 'cob_object_detection_msgs-msg:Mask))
   (pose
    :reader pose
    :initarg :pose
   ...
   (bounding_box_lwh
    :reader bounding_box_lwh
    :initarg :bounding_box_lwh
...
(cl:defmethod cl:initialize-instance :after ((m <Detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_object_detection_msgs-msg:<Detection> is deprecated: use cob_object_detection_msgs-msg:Detection instead.")))
...
(cl:defmethod label-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:label-val is deprecated.  Use cob_object_detection_msgs-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:id-val is deprecated.  Use cob_object_detection_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'detector-val :lambda-list '(m))
(cl:defmethod detector-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:detector-val is deprecated.  Use cob_object_detection_msgs-msg:detector instead.")
  (detector m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:score-val is deprecated.  Use cob_object_detection_msgs-msg:score instead.")
  (score m))
...
(cl:defmethod pose-val ((m <Detection>))
...
(cl:ensure-generic-function 'bounding_box_lwh-val :lambda-list '(m))
(cl:defmethod bounding_box_lwh-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:bounding_box_lwh-val is deprecated.  Use cob_object_detection_msgs-msg:bounding_box_lwh instead.")
  (bounding_box_lwh m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Detection>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'bounding_box_lwh) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Detection>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'bounding_box_lwh) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Detection>)))
  ...
  "5914d80850a216f4299709f0376ee04e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Detection)))
  "Returns md5sum for a message object of type 'Detection"
  "5914d80850a216f4299709f0376ee04e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Detection>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'bounding_box_lwh))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Detection>))
  ...
  (cl:list 'Detection
    ...
    (cl:cons ':bounding_box_lwh (bounding_box_lwh msg))
))
