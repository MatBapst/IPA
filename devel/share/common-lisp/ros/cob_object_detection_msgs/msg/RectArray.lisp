...
(cl:defclass <RectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rects
    :reader rects
    :initarg :rects
    :type (cl:vector cob_object_detection_msgs-msg:Rect)
   :initform (cl:make-array 0 :element-type 'cob_object_detection_msgs-msg:Rect :initial-element (cl:make-instance 'cob_object_detection_msgs-msg:Rect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_object_detection_msgs-msg:<RectArray> is deprecated: use cob_object_detection_msgs-msg:RectArray instead.")))
...
(cl:defmethod rects-val ((m <RectArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_object_detection_msgs-msg:rects-val is deprecated.  Use cob_object_detection_msgs-msg:rects instead.")
  (rects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_object_detection_msgs-msg:Rect))
