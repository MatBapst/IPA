...
if("TRUE" STREQUAL "TRUE")
  set(cob_object_detection_visualizer_SOURCE_PREFIX /home/mathieu/catkin_ws/src/cob_perception_common/cob_object_detection_visualizer)
  set(cob_object_detection_visualizer_DEVEL_PREFIX /home/mathieu/catkin_ws/devel)
  ...
  set(cob_object_detection_visualizer_INSTALL_PREFIX /home/mathieu/catkin_ws/install)
...
if(NOT "/usr/include;/usr/include/opencv;/usr/local/include/pcl-1.10;/usr/include/eigen-3.3.7;/usr/include/pcl-1.8;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(cob_object_detection_visualizer_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include;/usr/include/opencv;/usr/local/include/pcl-1.10;/usr/include/eigen-3.3.7;/usr/include/pcl-1.8;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cob_object_detection_visualizer_NUM_DUMMY_TARGETS)
      set(cob_object_detection_visualizer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cob_object_detection_visualizer::wrapped-linker-option${cob_object_detection_visualizer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cob_object_detection_visualizer_NUM_DUMMY_TARGETS "${cob_object_detection_visualizer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cob_object_detection_visualizer::wrapped-linker-option${cob_object_detection_visualizer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cob_object_detection_visualizer_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cob_object_detection_visualizer_dep}_FOUND)
      find_package(${cob_object_detection_visualizer_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cob_object_detection_visualizer_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
