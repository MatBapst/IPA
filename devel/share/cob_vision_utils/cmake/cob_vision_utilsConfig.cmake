...
if("TRUE" STREQUAL "TRUE")
  set(cob_vision_utils_SOURCE_PREFIX /home/mathieu/catkin_ws/src/cob_perception_common/cob_vision_utils)
  set(cob_vision_utils_DEVEL_PREFIX /home/mathieu/catkin_ws/devel)
  ...
  set(cob_vision_utils_INSTALL_PREFIX /home/mathieu/catkin_ws/install)
...
if(NOT "/home/mathieu/catkin_ws/src/cob_perception_common/cob_vision_utils/common/include;/home/mathieu/catkin_ws/src/cob_perception_common/cob_vision_utils/ros/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cob_vision_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/mathieu/catkin_ws/src/cob_perception_common/cob_vision_utils/common/include;/home/mathieu/catkin_ws/src/cob_perception_common/cob_vision_utils/ros/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/cob_vision_utils " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/cob_vision_utils' for information and consider reporting the problem.")
  else()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cob_vision_utils_NUM_DUMMY_TARGETS)
      set(cob_vision_utils_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cob_vision_utils::wrapped-linker-option${cob_vision_utils_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cob_vision_utils_NUM_DUMMY_TARGETS "${cob_vision_utils_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cob_vision_utils::wrapped-linker-option${cob_vision_utils_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cob_vision_utils_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cob_vision_utils_dep}_FOUND)
      find_package(${cob_vision_utils_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cob_vision_utils_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
