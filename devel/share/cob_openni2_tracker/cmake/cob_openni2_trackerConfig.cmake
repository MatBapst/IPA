...
if("TRUE" STREQUAL "TRUE")
  set(cob_openni2_tracker_SOURCE_PREFIX /home/mathieu/catkin_ws/src/cob_people_perception/cob_openni2_tracker)
  set(cob_openni2_tracker_DEVEL_PREFIX /home/mathieu/catkin_ws/devel)
  ...
  set(cob_openni2_tracker_INSTALL_PREFIX /home/mathieu/catkin_ws/install)
...
if(NOT "/home/mathieu/catkin_ws/src/cob_people_perception/cob_openni2_tracker/ros/include;/usr/include;/usr/include/opencv;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3 " STREQUAL " ")
  set(cob_openni2_tracker_INCLUDE_DIRS "")
  set(_include_dirs "/home/mathieu/catkin_ws/src/cob_people_perception/cob_openni2_tracker/ros/include;/usr/include;/usr/include/opencv;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cob_openni2_tracker_NUM_DUMMY_TARGETS)
      set(cob_openni2_tracker_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cob_openni2_tracker::wrapped-linker-option${cob_openni2_tracker_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cob_openni2_tracker_NUM_DUMMY_TARGETS "${cob_openni2_tracker_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cob_openni2_tracker::wrapped-linker-option${cob_openni2_tracker_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cob_openni2_tracker_LIBRARIES "${interface_target_name}")
...
set(depends "cob_perception_msgs;cv_bridge;geometry_msgs;image_transport;libnite2;roscpp;roslib;sensor_msgs;std_msgs;tf;nodelet;pcl_ros;visualization_msgs;message_runtime;nodelet;pcl_ros")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cob_openni2_tracker_dep}_FOUND)
      find_package(${cob_openni2_tracker_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cob_openni2_tracker_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
