...
let loadModelFeedback = require('./loadModelFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class loadModelActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new loadModelFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = loadModelFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new loadModelActionFeedback(null);
    ...
    data.feedback = loadModelFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new loadModelActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = loadModelFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new loadModelFeedback()
    }
...
module.exports = loadModelActionFeedback;
