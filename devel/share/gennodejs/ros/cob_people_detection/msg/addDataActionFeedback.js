...
let addDataFeedback = require('./addDataFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class addDataActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new addDataFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = addDataFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new addDataActionFeedback(null);
    ...
    data.feedback = addDataFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addDataActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = addDataFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new addDataFeedback()
    }
...
module.exports = addDataActionFeedback;
