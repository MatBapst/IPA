...
let cob_perception_msgs = _finder('cob_perception_msgs');

//-----------------------------------------------------------

class getDetectionsResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('detections')) {
        ...
        this.detections = new cob_perception_msgs.msg.DetectionArray();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = cob_perception_msgs.msg.DetectionArray.serialize(obj.detections, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new getDetectionsResult(null);
    // Deserialize message field [detections]
    data.detections = cob_perception_msgs.msg.DetectionArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += cob_perception_msgs.msg.DetectionArray.getMessageSize(object.detections);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new getDetectionsResult(null);
    if (msg.detections !== undefined) {
      resolved.detections = cob_perception_msgs.msg.DetectionArray.Resolve(msg.detections)
    }
    else {
      resolved.detections = new cob_perception_msgs.msg.DetectionArray()
    }
...
module.exports = getDetectionsResult;
