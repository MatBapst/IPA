...
class loadModelActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = loadModelGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += loadModelGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new loadModelActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = loadModelGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new loadModelGoal()
    }
