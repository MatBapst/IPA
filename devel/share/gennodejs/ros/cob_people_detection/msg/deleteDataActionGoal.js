...
let deleteDataGoal = require('./deleteDataGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class deleteDataActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = deleteDataGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += deleteDataGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new deleteDataActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = deleteDataGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new deleteDataGoal()
    }
...
module.exports = deleteDataActionGoal;
