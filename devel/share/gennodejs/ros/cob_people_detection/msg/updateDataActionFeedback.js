...
let updateDataFeedback = require('./updateDataFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class updateDataActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new updateDataFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = updateDataFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new updateDataActionFeedback(null);
    ...
    data.feedback = updateDataFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new updateDataActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = updateDataFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new updateDataFeedback()
    }
...
module.exports = updateDataActionFeedback;
