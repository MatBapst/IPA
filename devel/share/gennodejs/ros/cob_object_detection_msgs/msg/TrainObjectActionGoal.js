...
class TrainObjectActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrainObjectGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrainObjectGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrainObjectActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TrainObjectGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TrainObjectGoal()
    }
