...
let TrainObjectFeedback = require('./TrainObjectFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class TrainObjectActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TrainObjectFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrainObjectFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrainObjectActionFeedback(null);
    ...
    data.feedback = TrainObjectFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrainObjectActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrainObjectFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrainObjectFeedback()
    }
...
module.exports = TrainObjectActionFeedback;
