...
class TableObjectClusterResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TableObjectClusterResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TableObjectClusterResult(null);
...
module.exports = TableObjectClusterResult;
