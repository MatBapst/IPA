...
class TableObjectClusterAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TableObjectClusterActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = TableObjectClusterActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = TableObjectClusterActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TableObjectClusterAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = TableObjectClusterActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = TableObjectClusterActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = TableObjectClusterActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += TableObjectClusterActionGoal.getMessageSize(object.action_goal);
    length += TableObjectClusterActionResult.getMessageSize(object.action_result);
    length += TableObjectClusterActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TableObjectClusterAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = TableObjectClusterActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new TableObjectClusterActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = TableObjectClusterActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new TableObjectClusterActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = TableObjectClusterActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new TableObjectClusterActionFeedback()
    }
