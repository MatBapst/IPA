...
let PlaneExtractionFeedback = require('./PlaneExtractionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PlaneExtractionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlaneExtractionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlaneExtractionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlaneExtractionActionFeedback(null);
    ...
    data.feedback = PlaneExtractionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlaneExtractionFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaneExtractionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlaneExtractionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlaneExtractionFeedback()
    }
...
module.exports = PlaneExtractionActionFeedback;
