...
class TriggerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TriggerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TriggerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TriggerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TriggerGoal()
    }
