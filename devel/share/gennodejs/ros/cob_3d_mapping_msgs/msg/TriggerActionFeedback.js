...
let TriggerFeedback = require('./TriggerFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class TriggerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TriggerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TriggerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TriggerActionFeedback(null);
    ...
    data.feedback = TriggerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TriggerFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TriggerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TriggerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TriggerFeedback()
    }
...
module.exports = TriggerActionFeedback;
