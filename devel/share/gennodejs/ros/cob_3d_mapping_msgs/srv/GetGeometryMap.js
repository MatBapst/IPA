...
class GetGeometryMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGeometryMapRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGeometryMapRequest
    let len;
    let data = new GetGeometryMapRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'cob_3d_mapping_msgs/GetGeometryMapRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGeometryMapRequest(null);
    return resolved;
    }
};

class GetGeometryMapResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.map = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGeometryMapResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGeometryMapResponse
    let len;
    let data = new GetGeometryMapResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cob_3d_mapping_msgs/GetGeometryMapResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGeometryMapResponse(null);
...
module.exports = {
  Request: GetGeometryMapRequest,
  Response: GetGeometryMapResponse,
  md5sum() { return 'f00740a6f429ef52cd72626c52eeda1c'; },
  datatype() { return 'cob_3d_mapping_msgs/GetGeometryMap'; }
};
