...
class SetGeometryMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGeometryMapRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGeometryMapRequest
    let len;
    let data = new SetGeometryMapRequest(null);
  ...
  static datatype() {
    ...
    return 'cob_3d_mapping_msgs/SetGeometryMapRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGeometryMapRequest(null);
...
class SetGeometryMapResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGeometryMapResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGeometryMapResponse
    let len;
    let data = new SetGeometryMapResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cob_3d_mapping_msgs/SetGeometryMapResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGeometryMapResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: SetGeometryMapRequest,
  Response: SetGeometryMapResponse,
  md5sum() { return 'f00740a6f429ef52cd72626c52eeda1c'; },
  datatype() { return 'cob_3d_mapping_msgs/SetGeometryMap'; }
};
