...
"""autogenerated by genpy from cob_3d_mapping_msgs/ModifyMapRequest.msg. Do not edit."""
import sys
...
class ModifyMapRequest(genpy.Message):
  _md5sum = "ea968d0c07a800a6b17527a191a32e88"
  _type = "cob_3d_mapping_msgs/ModifyMapRequest"
...
"""
  ...
  __slots__ = ['action','shapes']
  _slot_types = ['int32','cob_3d_mapping_msgs/ShapeArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.shapes is None:
        self.shapes = cob_3d_mapping_msgs.msg.ShapeArray()
    else:
      self.action = 0
      self.shapes = cob_3d_mapping_msgs.msg.ShapeArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action, _x.shapes.header.seq, _x.shapes.header.stamp.secs, _x.shapes.header.stamp.nsecs))
      _x = self.shapes.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.shapes.shapes)
      buff.write(_struct_I.pack(length))
      for val1 in self.shapes.shapes:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action, _x.shapes.header.seq, _x.shapes.header.stamp.secs, _x.shapes.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.shapes.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.shapes.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.shapes.shapes = []
      for i in range(0, length):
        ...
        self.shapes.shapes.append(val1)
      return self
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cob_3d_mapping_msgs/ModifyMapResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ModifyMapResponse(genpy.Message):
  ...
  _type = "cob_3d_mapping_msgs/ModifyMapResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
...
class ModifyMap(object):
  _type          = 'cob_3d_mapping_msgs/ModifyMap'
  _md5sum = 'ea968d0c07a800a6b17527a191a32e88'
