...
"""autogenerated by genpy from cob_3d_mapping_msgs/GetTablesRequest.msg. Do not edit."""
import sys
...
class GetTablesRequest(genpy.Message):
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cob_3d_mapping_msgs/GetTablesResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetTablesResponse(genpy.Message):
  _md5sum = "66dab6432264ad910ef67f2a1c240146"
  _type = "cob_3d_mapping_msgs/GetTablesResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """cob_3d_mapping_msgs/ShapeArray tables
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.tables is None:
        self.tables = cob_3d_mapping_msgs.msg.ShapeArray()
    else:
      self.tables = cob_3d_mapping_msgs.msg.ShapeArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.tables.header.seq, _x.tables.header.stamp.secs, _x.tables.header.stamp.nsecs))
      _x = self.tables.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.tables.shapes)
      buff.write(_struct_I.pack(length))
      for val1 in self.tables.shapes:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tables.header.seq, _x.tables.header.stamp.secs, _x.tables.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.tables.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.tables.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.tables.shapes = []
      for i in range(0, length):
        ...
        self.tables.shapes.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
