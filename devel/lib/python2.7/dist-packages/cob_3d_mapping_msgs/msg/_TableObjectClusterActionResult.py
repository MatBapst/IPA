...
"""autogenerated by genpy from cob_3d_mapping_msgs/TableObjectClusterActionResult.msg. Do not edit."""
import sys
...
class TableObjectClusterActionResult(genpy.Message):
  _md5sum = "e9a500864cad0f17b191d7e31020df77"
  _type = "cob_3d_mapping_msgs/TableObjectClusterActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_3d_mapping_msgs/TableObjectClusterResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TableObjectClusterActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_3d_mapping_msgs.msg.TableObjectClusterResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_3d_mapping_msgs.msg.TableObjectClusterResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.bounding_boxes.header.seq, _x.result.bounding_boxes.header.stamp.secs, _x.result.bounding_boxes.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.bounding_boxes.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.bounding_boxes.detections:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.bounding_boxes.header.seq, _x.result.bounding_boxes.header.stamp.secs, _x.result.bounding_boxes.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.result.bounding_boxes.detections = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.result.bounding_boxes.detections.append(val1)
      return self
