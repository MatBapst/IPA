...
"""autogenerated by genpy from cob_3d_mapping_msgs/TableObjectClusterActionFeedback.msg. Do not edit."""
import sys
...
class TableObjectClusterActionFeedback(genpy.Message):
  _md5sum = "fd657a69fe86b758d188e038f0b860e5"
  _type = "cob_3d_mapping_msgs/TableObjectClusterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_3d_mapping_msgs/TableObjectClusterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TableObjectClusterActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_3d_mapping_msgs.msg.TableObjectClusterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_3d_mapping_msgs.msg.TableObjectClusterFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.currentStep.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.currentStep.data = str[start:end].decode('utf-8')
      else:
        self.feedback.currentStep.data = str[start:end]
      return self
