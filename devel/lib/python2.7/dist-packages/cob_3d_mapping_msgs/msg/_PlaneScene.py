...
"""autogenerated by genpy from cob_3d_mapping_msgs/PlaneScene.msg. Do not edit."""
import sys
...
class PlaneScene(genpy.Message):
  _md5sum = "5aa30c5b0316a946cb91f45ed3f1d963"
  _type = "cob_3d_mapping_msgs/PlaneScene"
...
float32 a
"""
  __slots__ = ['header','planes']
  _slot_types = ['std_msgs/Header','cob_3d_mapping_msgs/Plane[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaneScene, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.planes:
        ...
        buff.write(_get_struct_f().pack(val1.weight))
        _v4 = val1.color
        _x = _v4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cob_3d_mapping_msgs.msg.Plane()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.polygons = []
        for i in range(0, length):
          val2 = cob_3d_mapping_msgs.msg.Polygon()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.points = []
          for i in range(0, length):
            val3 = cob_3d_mapping_msgs.msg.Point2D()
            _x = val3
            start = end
            end += 20
