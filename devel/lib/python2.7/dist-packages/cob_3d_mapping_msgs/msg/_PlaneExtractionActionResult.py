...
"""autogenerated by genpy from cob_3d_mapping_msgs/PlaneExtractionActionResult.msg. Do not edit."""
import sys
...
class PlaneExtractionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_3d_mapping_msgs/PlaneExtractionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_3d_mapping_msgs/PlaneExtractionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaneExtractionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_3d_mapping_msgs.msg.PlaneExtractionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_3d_mapping_msgs.msg.PlaneExtractionResult()
