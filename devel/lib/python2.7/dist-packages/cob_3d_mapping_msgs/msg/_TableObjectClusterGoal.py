...
"""autogenerated by genpy from cob_3d_mapping_msgs/TableObjectClusterGoal.msg. Do not edit."""
import sys
...
class TableObjectClusterGoal(genpy.Message):
  _md5sum = "81a746b0e990b3cd67733ad5c859eff8"
  _type = "cob_3d_mapping_msgs/TableObjectClusterGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TableObjectClusterGoal, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.known_objects is None:
        self.known_objects = cob_object_detection_msgs.msg.DetectionArray()
    else:
      self.known_objects = cob_object_detection_msgs.msg.DetectionArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.known_objects.header.seq, _x.known_objects.header.stamp.secs, _x.known_objects.header.stamp.nsecs))
      _x = self.known_objects.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.known_objects.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.known_objects.detections:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.known_objects.header.seq, _x.known_objects.header.stamp.secs, _x.known_objects.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.known_objects.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.known_objects.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.known_objects.detections = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.known_objects.detections.append(val1)
      return self
