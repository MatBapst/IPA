...
"""autogenerated by genpy from cob_3d_mapping_msgs/CurvedPolygonArray.msg. Do not edit."""
import sys
...
class CurvedPolygonArray(genpy.Message):
  _md5sum = "dca7a231f0d66f77a98e4e50cf3157dc"
  _type = "cob_3d_mapping_msgs/CurvedPolygonArray"
...
uint32 ID"""
  ...
  _slot_types = ['std_msgs/Header','cob_3d_mapping_msgs/CurvedPolygon[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CurvedPolygonArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.polygons:
        ...
        buff.write(_get_struct_6f().pack(*val1.parameter))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.parameter = _get_struct_6f().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.score = []
