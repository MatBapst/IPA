...
"""autogenerated by genpy from cob_3d_mapping_msgs/TriggerAction.msg. Do not edit."""
import sys
...
class TriggerAction(genpy.Message):
  _md5sum = "6b11d5bad4b3155b0b4cb6b6baa9da4c"
  _type = "cob_3d_mapping_msgs/TriggerAction"
...
"""
  ...
  _slot_types = ['cob_3d_mapping_msgs/TriggerActionGoal','cob_3d_mapping_msgs/TriggerActionResult','cob_3d_mapping_msgs/TriggerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = cob_3d_mapping_msgs.msg.TriggerActionGoal()
      if self.action_result is None:
        self.action_result = cob_3d_mapping_msgs.msg.TriggerActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_3d_mapping_msgs.msg.TriggerActionFeedback()
    else:
      self.action_goal = cob_3d_mapping_msgs.msg.TriggerActionGoal()
      self.action_result = cob_3d_mapping_msgs.msg.TriggerActionResult()
      self.action_feedback = cob_3d_mapping_msgs.msg.TriggerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.message.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.message.data = str[start:end].decode('utf-8')
      else:
        self.action_result.result.message.data = str[start:end]
      _x = self
      start = end
      end += 12
