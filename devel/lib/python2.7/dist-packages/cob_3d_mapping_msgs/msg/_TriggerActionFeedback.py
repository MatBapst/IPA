...
"""autogenerated by genpy from cob_3d_mapping_msgs/TriggerActionFeedback.msg. Do not edit."""
import sys
...
class TriggerActionFeedback(genpy.Message):
  _md5sum = "fd657a69fe86b758d188e038f0b860e5"
  _type = "cob_3d_mapping_msgs/TriggerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_3d_mapping_msgs/TriggerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TriggerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_3d_mapping_msgs.msg.TriggerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_3d_mapping_msgs.msg.TriggerFeedback()
