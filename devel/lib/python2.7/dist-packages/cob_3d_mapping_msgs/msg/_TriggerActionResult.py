...
"""autogenerated by genpy from cob_3d_mapping_msgs/TriggerActionResult.msg. Do not edit."""
import sys
...
class TriggerActionResult(genpy.Message):
  _md5sum = "9d927c58f7819a6901de576111376444"
  _type = "cob_3d_mapping_msgs/TriggerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_3d_mapping_msgs/TriggerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TriggerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_3d_mapping_msgs.msg.TriggerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_3d_mapping_msgs.msg.TriggerResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.message.data = str[start:end].decode('utf-8')
      else:
        self.result.message.data = str[start:end]
      return self
