...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2if().pack(_x.goal.capture_mode, _x.goal.continuous_mode_images_to_capture, _x.goal.continuous_mode_delay))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.capture_mode, _x.goal.continuous_mode_images_to_capture, _x.goal.continuous_mode_delay,) = _get_struct_2if().unpack(str[start:end])
      return self
