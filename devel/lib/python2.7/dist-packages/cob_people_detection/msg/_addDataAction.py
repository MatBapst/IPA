...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2if3I().pack(_x.action_goal.goal.capture_mode, _x.action_goal.goal.continuous_mode_images_to_capture, _x.action_goal.goal.continuous_mode_delay, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.action_feedback.feedback.images_captured))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.capture_mode, _x.action_goal.goal.continuous_mode_images_to_capture, _x.action_goal.goal.continuous_mode_delay, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2if3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.images_captured,) = _get_struct_i().unpack(str[start:end])
      return self
