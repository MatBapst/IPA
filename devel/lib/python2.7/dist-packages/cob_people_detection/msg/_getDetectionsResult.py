...
"""autogenerated by genpy from cob_people_detection/getDetectionsResult.msg. Do not edit."""
import sys
...
class getDetectionsResult(genpy.Message):
  _md5sum = "d4fea4ec02d40e91b8763e3a06791220"
  _type = "cob_people_detection/getDetectionsResult"
...
"""
  ...
  _slot_types = ['cob_perception_msgs/DetectionArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(getDetectionsResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.detections is None:
        self.detections = cob_perception_msgs.msg.DetectionArray()
    else:
      self.detections = cob_perception_msgs.msg.DetectionArray()
