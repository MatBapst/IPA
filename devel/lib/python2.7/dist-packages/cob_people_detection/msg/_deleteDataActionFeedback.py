...
"""autogenerated by genpy from cob_people_detection/deleteDataActionFeedback.msg. Do not edit."""
import sys
...
class deleteDataActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "cob_people_detection/deleteDataActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_people_detection/deleteDataFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(deleteDataActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_people_detection.msg.deleteDataFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_people_detection.msg.deleteDataFeedback()
