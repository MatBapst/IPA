...
"""autogenerated by genpy from cob_people_detection/loadModelAction.msg. Do not edit."""
import sys
...
class loadModelAction(genpy.Message):
  _md5sum = "c40769543e0db931e25645f1e1781baa"
  _type = "cob_people_detection/loadModelAction"
...
"""
  ...
  _slot_types = ['cob_people_detection/loadModelActionGoal','cob_people_detection/loadModelActionResult','cob_people_detection/loadModelActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(loadModelAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_people_detection.msg.loadModelActionGoal()
      if self.action_result is None:
        self.action_result = cob_people_detection.msg.loadModelActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_people_detection.msg.loadModelActionFeedback()
    else:
      self.action_goal = cob_people_detection.msg.loadModelActionGoal()
      self.action_result = cob_people_detection.msg.loadModelActionResult()
      self.action_feedback = cob_people_detection.msg.loadModelActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.labels)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.labels:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.labels.append(val1)
      _x = self
      start = end
      end += 12
