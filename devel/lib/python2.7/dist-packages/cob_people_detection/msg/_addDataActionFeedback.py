...
"""autogenerated by genpy from cob_people_detection/addDataActionFeedback.msg. Do not edit."""
import sys
...
class addDataActionFeedback(genpy.Message):
  _md5sum = "fe7619910ed5432f7fac7cb217bc9a56"
  _type = "cob_people_detection/addDataActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_people_detection/addDataFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addDataActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_people_detection.msg.addDataFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_people_detection.msg.addDataFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.images_captured))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.images_captured,) = _get_struct_i().unpack(str[start:end])
      return self
