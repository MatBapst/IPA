...
"""autogenerated by genpy from cob_people_detection/deleteDataAction.msg. Do not edit."""
import sys
...
class deleteDataAction(genpy.Message):
  _md5sum = "33a6a28b610f8f415e8efd5e98310888"
  _type = "cob_people_detection/deleteDataAction"
...
"""
  ...
  _slot_types = ['cob_people_detection/deleteDataActionGoal','cob_people_detection/deleteDataActionResult','cob_people_detection/deleteDataActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(deleteDataAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_people_detection.msg.deleteDataActionGoal()
      if self.action_result is None:
        self.action_result = cob_people_detection.msg.deleteDataActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_people_detection.msg.deleteDataActionFeedback()
    else:
      self.action_goal = cob_people_detection.msg.deleteDataActionGoal()
      self.action_result = cob_people_detection.msg.deleteDataActionResult()
      self.action_feedback = cob_people_detection.msg.deleteDataActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.action_goal.goal.delete_mode, _x.action_goal.goal.delete_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.delete_mode, _x.action_goal.goal.delete_index,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
