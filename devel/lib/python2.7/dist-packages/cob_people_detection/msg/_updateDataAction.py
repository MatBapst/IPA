...
"""autogenerated by genpy from cob_people_detection/updateDataAction.msg. Do not edit."""
import sys
...
class updateDataAction(genpy.Message):
  _md5sum = "f7ca18c811ae67ebed8cd0d90e57ae34"
  _type = "cob_people_detection/updateDataAction"
...
"""
  ...
  _slot_types = ['cob_people_detection/updateDataActionGoal','cob_people_detection/updateDataActionResult','cob_people_detection/updateDataActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(updateDataAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_people_detection.msg.updateDataActionGoal()
      if self.action_result is None:
        self.action_result = cob_people_detection.msg.updateDataActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_people_detection.msg.updateDataActionFeedback()
    else:
      self.action_goal = cob_people_detection.msg.updateDataActionGoal()
      self.action_result = cob_people_detection.msg.updateDataActionResult()
      self.action_feedback = cob_people_detection.msg.updateDataActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.action_goal.goal.update_mode, _x.action_goal.goal.update_index))
      _x = self.action_goal.goal.old_label
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.new_label
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.update_mode, _x.action_goal.goal.update_index,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.old_label = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.old_label = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.new_label = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.new_label = str[start:end]
      _x = self
      start = end
      end += 12
