...
"""autogenerated by genpy from cob_people_detection/updateDataActionResult.msg. Do not edit."""
import sys
...
class updateDataActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_people_detection/updateDataActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_people_detection/updateDataResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(updateDataActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_people_detection.msg.updateDataResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_people_detection.msg.updateDataResult()
