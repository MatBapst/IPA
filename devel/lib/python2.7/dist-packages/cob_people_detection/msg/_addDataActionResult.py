...
"""autogenerated by genpy from cob_people_detection/addDataActionResult.msg. Do not edit."""
import sys
...
class addDataActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_people_detection/addDataActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_people_detection/addDataResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addDataActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_people_detection.msg.addDataResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_people_detection.msg.addDataResult()
