...
"""autogenerated by genpy from cob_people_detection/deleteDataActionResult.msg. Do not edit."""
import sys
...
class deleteDataActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_people_detection/deleteDataActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_people_detection/deleteDataResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(deleteDataActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_people_detection.msg.deleteDataResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_people_detection.msg.deleteDataResult()
