...
"""autogenerated by genpy from cob_object_detection_msgs/DetectObjectsResult.msg. Do not edit."""
import sys
...
class DetectObjectsResult(genpy.Message):
  _md5sum = "6da5c76956a10a2b2a7e649614ba9504"
  _type = "cob_object_detection_msgs/DetectObjectsResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectObjectsResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.object_list.header.seq, _x.object_list.header.stamp.secs, _x.object_list.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object_list.header.seq, _x.object_list.header.stamp.secs, _x.object_list.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
