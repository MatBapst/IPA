...
"""autogenerated by genpy from cob_object_detection_msgs/TrainObjectActionResult.msg. Do not edit."""
import sys
...
class TrainObjectActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cob_object_detection_msgs/TrainObjectActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_object_detection_msgs/TrainObjectResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrainObjectActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_object_detection_msgs.msg.TrainObjectResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_object_detection_msgs.msg.TrainObjectResult()
