...
"""autogenerated by genpy from cob_object_detection_msgs/DetectObjectsActionResult.msg. Do not edit."""
import sys
...
class DetectObjectsActionResult(genpy.Message):
  _md5sum = "5bc0a069eaf70d7034626185f3759add"
  _type = "cob_object_detection_msgs/DetectObjectsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_object_detection_msgs/DetectObjectsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectObjectsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_object_detection_msgs.msg.DetectObjectsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_object_detection_msgs.msg.DetectObjectsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.object_list.header.seq, _x.result.object_list.header.stamp.secs, _x.result.object_list.header.stamp.nsecs))
      _x = self.result.object_list.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.object_list.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.object_list.detections:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.object_list.header.seq, _x.result.object_list.header.stamp.secs, _x.result.object_list.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.object_list.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.object_list.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.object_list.detections = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.result.object_list.detections.append(val1)
      return self
