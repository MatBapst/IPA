...
"""autogenerated by genpy from cob_object_detection_msgs/RectArray.msg. Do not edit."""
import sys
...
class RectArray(genpy.Message):
  ...
  _type = "cob_object_detection_msgs/RectArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','cob_object_detection_msgs/Rect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cob_object_detection_msgs.msg.Rect()
        _x = val1
        start = end
        end += 16
