...
"""autogenerated by genpy from cob_object_detection_msgs/TrainObjectActionFeedback.msg. Do not edit."""
import sys
...
class TrainObjectActionFeedback(genpy.Message):
  _md5sum = "25bfb21ced59f4f9490772d56f6961f4"
  _type = "cob_object_detection_msgs/TrainObjectActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_object_detection_msgs/TrainObjectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrainObjectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_object_detection_msgs.msg.TrainObjectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_object_detection_msgs.msg.TrainObjectFeedback()
