...
"""autogenerated by genpy from cob_object_detection_msgs/Mask.msg. Do not edit."""
import sys
...
class Mask(genpy.Message):
  ...
  _type = "cob_object_detection_msgs/Mask"
...
"""
  __slots__ = ['roi','mask']
  _slot_types = ['cob_object_detection_msgs/Rect','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.roi is None:
        self.roi = cob_object_detection_msgs.msg.Rect()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4i3I().pack(_x.roi.x, _x.roi.y, _x.roi.width, _x.roi.height, _x.mask.header.seq, _x.mask.header.stamp.secs, _x.mask.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roi.x, _x.roi.y, _x.roi.width, _x.roi.height, _x.mask.header.seq, _x.mask.header.stamp.secs, _x.mask.header.stamp.nsecs,) = _get_struct_4i3I().unpack(str[start:end])
      start = end
      end += 4
