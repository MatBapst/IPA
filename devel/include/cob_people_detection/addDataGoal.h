...
bool operator==(const ::cob_people_detection::addDataGoal_<ContainerAllocator1> & lhs, const ::cob_people_detection::addDataGoal_<ContainerAllocator2> & rhs)
{
  return lhs.label == rhs.label &&
    lhs.capture_mode == rhs.capture_mode &&
    lhs.continuous_mode_images_to_capture == rhs.continuous_mode_images_to_capture &&
    lhs.continuous_mode_delay == rhs.continuous_mode_delay;
}
