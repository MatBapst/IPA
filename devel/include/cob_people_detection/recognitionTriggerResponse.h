// Generated by gencpp from file cob_people_detection/recognitionTriggerResponse.msg
// DO NOT EDIT!


#ifndef COB_PEOPLE_DETECTION_MESSAGE_RECOGNITIONTRIGGERRESPONSE_H
#define COB_PEOPLE_DETECTION_MESSAGE_RECOGNITIONTRIGGERRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::cob_people_detection::recognitionTriggerResponse_<ContainerAllocator>&)
  {}
};
...
#endif // COB_PEOPLE_DETECTION_MESSAGE_RECOGNITIONTRIGGERRESPONSE_H
