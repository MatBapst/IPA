...
bool operator==(const ::cob_people_detection::deleteDataGoal_<ContainerAllocator1> & lhs, const ::cob_people_detection::deleteDataGoal_<ContainerAllocator2> & rhs)
{
  return lhs.delete_mode == rhs.delete_mode &&
    lhs.delete_index == rhs.delete_index &&
    lhs.label == rhs.label;
}
