...
bool operator==(const ::cob_people_detection::getDetectionsAction_<ContainerAllocator1> & lhs, const ::cob_people_detection::getDetectionsAction_<ContainerAllocator2> & rhs)
{
