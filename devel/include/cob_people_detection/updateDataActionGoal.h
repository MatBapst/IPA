...
bool operator==(const ::cob_people_detection::updateDataActionGoal_<ContainerAllocator1> & lhs, const ::cob_people_detection::updateDataActionGoal_<ContainerAllocator2> & rhs)
{
