...
bool operator==(const ::cob_3d_mapping_msgs::GetApproachPoseForPolygonResponse_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::GetApproachPoseForPolygonResponse_<ContainerAllocator2> & rhs)
{
  return lhs.approach_poses == rhs.approach_poses;
}
