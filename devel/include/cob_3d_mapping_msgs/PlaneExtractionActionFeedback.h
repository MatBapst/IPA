...
bool operator==(const ::cob_3d_mapping_msgs::PlaneExtractionActionFeedback_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::PlaneExtractionActionFeedback_<ContainerAllocator2> & rhs)
{
