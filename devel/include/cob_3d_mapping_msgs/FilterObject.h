...
bool operator==(const ::cob_3d_mapping_msgs::FilterObject_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::FilterObject_<ContainerAllocator2> & rhs)
{
  return lhs.height == rhs.height &&
    lhs.width == rhs.width &&
    lhs.curv_h == rhs.curv_h &&
    lhs.curv_w == rhs.curv_w;
}
