...
bool operator==(const ::cob_3d_mapping_msgs::UpdateMapResponse_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::UpdateMapResponse_<ContainerAllocator2> & rhs)
{
