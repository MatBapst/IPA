...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef LINE
#endif
#if defined(_WIN32) && defined(CURVED)
  #undef CURVED
#endif
...
bool operator==(const ::cob_3d_mapping_msgs::Shape_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::Shape_<ContainerAllocator2> & rhs)
{
