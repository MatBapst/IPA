...
bool operator==(const ::cob_3d_mapping_msgs::TriggerActionGoal_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::TriggerActionGoal_<ContainerAllocator2> & rhs)
{
