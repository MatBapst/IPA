...
bool operator==(const ::cob_3d_mapping_msgs::TableObjectClusterFeedback_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::TableObjectClusterFeedback_<ContainerAllocator2> & rhs)
{
