...
bool operator==(const ::cob_3d_mapping_msgs::TableObjectClusterResult_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::TableObjectClusterResult_<ContainerAllocator2> & rhs)
{
