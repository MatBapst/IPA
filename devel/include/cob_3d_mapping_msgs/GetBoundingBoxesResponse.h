...
bool operator==(const ::cob_3d_mapping_msgs::GetBoundingBoxesResponse_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::GetBoundingBoxesResponse_<ContainerAllocator2> & rhs)
{
