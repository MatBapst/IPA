// Generated by gencpp from file cob_3d_mapping_msgs/ModifyMapRequest.msg
// DO NOT EDIT!


#ifndef COB_3D_MAPPING_MSGS_MESSAGE_MODIFYMAPREQUEST_H
#define COB_3D_MAPPING_MSGS_MESSAGE_MODIFYMAPREQUEST_H
...
struct ModifyMapRequest_
{
  ...
  _action_type action;
   ...
   typedef  ::cob_3d_mapping_msgs::ShapeArray_<ContainerAllocator>  _shapes_type;
  _shapes_type shapes;
...
std::ostream& operator<<(std::ostream& s, const ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
struct MD5Sum< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xea968d0c07a800a6ULL;
  static const uint64_t static_value2 = 0xb17527a191a32e88ULL;
};
...
template<class ContainerAllocator>
struct Printer< ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_3d_mapping_msgs::ModifyMapRequest_<ContainerAllocator>& v)
  {
    s << indent << "action: ";
    Printer<int32_t>::stream(s, indent + "  ", v.action);
    s << indent << "shapes: ";
    s << std::endl;
    Printer< ::cob_3d_mapping_msgs::ShapeArray_<ContainerAllocator> >::stream(s, indent + "  ", v.shapes);
  }
};
...
#endif // COB_3D_MAPPING_MSGS_MESSAGE_MODIFYMAPREQUEST_H
