...
bool operator==(const ::cob_3d_mapping_msgs::GetPlaneResponse_<ContainerAllocator1> & lhs, const ::cob_3d_mapping_msgs::GetPlaneResponse_<ContainerAllocator2> & rhs)
{
  return lhs.pc == rhs.pc &&
    lhs.hull == rhs.hull &&
    lhs.plane_coeffs == rhs.plane_coeffs;
}
