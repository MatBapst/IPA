...
bool operator==(const ::cob_object_detection_msgs::TrainObjectActionGoal_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::TrainObjectActionGoal_<ContainerAllocator2> & rhs)
{
