...
bool operator==(const ::cob_object_detection_msgs::DetectObjectsActionResult_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::DetectObjectsActionResult_<ContainerAllocator2> & rhs)
{
