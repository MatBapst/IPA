...
bool operator==(const ::cob_object_detection_msgs::DetectObjectsResponse_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::DetectObjectsResponse_<ContainerAllocator2> & rhs)
{
