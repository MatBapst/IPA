...
bool operator==(const ::cob_object_detection_msgs::AcquireObjectImageAction_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::AcquireObjectImageAction_<ContainerAllocator2> & rhs)
{
