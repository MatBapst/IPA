...
bool operator==(const ::cob_object_detection_msgs::BaTestEnvironmentResponse_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::BaTestEnvironmentResponse_<ContainerAllocator2> & rhs)
{
  return lhs.mean_error == rhs.mean_error &&
    lhs.std_dev == rhs.std_dev &&
    lhs.min_error == rhs.min_error &&
    lhs.max_error == rhs.max_error &&
    lhs.runs_count == rhs.runs_count &&
    lhs.runs_sum == rhs.runs_sum &&
    lhs.runs_sum2 == rhs.runs_sum2 &&
    lhs.time_duration == rhs.time_duration &&
    lhs.observations == rhs.observations &&
    lhs.false_matchings == rhs.false_matchings &&
