...
bool operator==(const ::cob_object_detection_msgs::StartObjectRecordingRequest_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::StartObjectRecordingRequest_<ContainerAllocator2> & rhs)
{
