...
bool operator==(const ::cob_object_detection_msgs::BaTestEnvironmentRequest_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::BaTestEnvironmentRequest_<ContainerAllocator2> & rhs)
{
  return lhs.number_points == rhs.number_points &&
    lhs.frame_view_number == rhs.frame_view_number &&
    lhs.cone_points_per_plane == rhs.cone_points_per_plane &&
    lhs.limit_error_matching == rhs.limit_error_matching &&
    lhs.ba_kernel_param == rhs.ba_kernel_param &&
    lhs.ba_num_iter == rhs.ba_num_iter &&
    lhs.ba_initial_mu == rhs.ba_initial_mu &&
    lhs.ba_final_mu_factor == rhs.ba_final_mu_factor &&
    lhs.ba_tau == rhs.ba_tau &&
    lhs.angle_sigma_degree == rhs.angle_sigma_degree &&
    lhs.translate_sigma_m == rhs.translate_sigma_m &&
    lhs.obs_point_sigma_m == rhs.obs_point_sigma_m &&
    lhs.world_point_sigma_m == rhs.world_point_sigma_m;
}
