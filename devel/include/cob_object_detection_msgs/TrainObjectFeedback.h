...
bool operator==(const ::cob_object_detection_msgs::TrainObjectFeedback_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::TrainObjectFeedback_<ContainerAllocator2> & rhs)
{
