...
bool operator==(const ::cob_object_detection_msgs::DetectObjectsAction_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::DetectObjectsAction_<ContainerAllocator2> & rhs)
{
