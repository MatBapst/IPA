...
bool operator==(const ::cob_object_detection_msgs::TrainObjectRequest_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::TrainObjectRequest_<ContainerAllocator2> & rhs)
{
