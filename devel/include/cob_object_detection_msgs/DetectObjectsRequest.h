...
bool operator==(const ::cob_object_detection_msgs::DetectObjectsRequest_<ContainerAllocator1> & lhs, const ::cob_object_detection_msgs::DetectObjectsRequest_<ContainerAllocator2> & rhs)
{
